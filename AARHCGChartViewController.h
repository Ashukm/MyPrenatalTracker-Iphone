...
@interface AARHCGChartViewController : UIViewController<CPTPlotSpaceDelegate,CPTRangePlotDataSource>
{
...
@property (nonatomic) AARCycle* hcgChartCycle;
